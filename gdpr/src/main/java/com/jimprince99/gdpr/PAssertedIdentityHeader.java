 ...
 */
public interface PAssertedIdentityHeader extends AddressParametersHeader {
...
//public interface FromHeader extends AddressParametersHeader {
    ...
    //@Override
    PAssertedIdentityHeader clone();

    
    default boolean isPAssertedIdentiryHeader() {
        return true;
    }

    default PAssertedIdentityHeader toPAssertedIdentityHeader() {
        return this;
    }
